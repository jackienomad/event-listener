...
export default cleanEnv(process.env, {
  ...
  SERVER_NAME: str({
    desc: 'Referenece to your server name. Replace this when your app is hosted',
    devDefault: '',
  }),
  ...
  STREAMS_ID: str({
    desc: 'Moralis streams id',
    default: '',
  }),
  AISKINS_FACTORY_ADDRESS: str({
    desc: 'Contract address of AISkin Factory',
    default: ''
  }),
  AISKINS_MASTER_COLLECTION_ADDRESS: str({
    desc: 'Contract address of AISkin Master Collection',
    default: ''
  }),
  ENV: str({
    desc: 'Environment',
